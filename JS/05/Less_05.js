...
/*Multiply table slice ==== Використовуючи slice, створіть масив масивів (іншу таблицю/матрицю) з таблиці множення, в якій не буде нулів */
{
    ...
    arrNew[0] = arrNew[0].slice(1)
    arrNew[1] = arrNew[1].slice(1)
    arrNew[2] = arrNew[2].slice(1)
    arrNew[3] = arrNew[3].slice(1)
    alert(arrNew)
}
...
/*Filter Lexics ==== Нехай користувач вводить рядок. Розбийте його за пробілами. Використовуючи filter 
                        ...
                        Зберіть масив у рядок назад. 299*/
{    
...
/*Beep Lexics ==== Нехай користувач вводить рядок. Розбийте його за пробілами. Використовуючи map та тернарний оператор 317
